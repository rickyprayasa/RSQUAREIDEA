...
export function ProductForm({ product, categories }: ProductFormProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        videoTutorialUrl: product?.video_tutorial_url || '',
                            ...
                            <div className="border-t border-gray-100 pt-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        />
                                        <p className="text-xs text-gray-500 mt-1">Link video tutorial YouTube untuk produk ini</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {activeTab === 'settings' && (
                        <div className="space-y-6">
                            <div className="space-y-4">
                                ...
                                <label className="flex items-start gap-4 p-4 bg-purple-50 rounded-xl cursor-pointer hover:bg-purple-100 transition-colors border border-purple-200">
                                    <input
                                        type="checkbox"
                                        name="isCustomShowcase"
                                        checked={formData.isCustomShowcase}
                                        onChange={handleChange}
                                        className="w-5 h-5 mt-0.5 rounded border-gray-300 text-purple-500 focus:ring-purple-500"
                                    />
                                    <div>
                                        <span className="font-medium text-gray-900">Custom Showcase (Portfolio)</span>
                                        <p className="text-sm text-gray-500 mt-0.5">Produk ini adalah hasil custom request. Tidak bisa dibeli, hanya untuk portfolio showcase</p>
                                    </div>
                                </label>
                                ...
                                {formData.isCustomShowcase && (
                                    <div className="p-4 bg-purple-50 rounded-xl border border-purple-200">
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                            className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                                        >
                                            <option value="">-- Pilih Tipe --</option>
                                            <option value="sheets">Google Sheets Template</option>
                                            <option value="webapp">Google Web App</option>
