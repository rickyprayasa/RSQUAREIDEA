...
import { toast } from 'sonner' // Assuming sonner is used or will be used, wait, user mentioned sonner? I'll assume usage or remove if not available.
// Actually products page didn't use toast, but I requested installation of sonner in the plan.
// If I can't be sure, I'll stick to console error or simple alert if sonner not setup.
// But I saw `toast` in my previous thought? No.
// Let's remove toast for now and just use router.refresh() like ProductButton.
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        ...
                        >
                            ...
                            <p className="text-gray-500 text-sm mb-6 text-center">
                                Anda yakin ingin menghapus &quot;{articleTitle}&quot;? Tindakan ini tidak dapat dibatalkan.
                            </p>
