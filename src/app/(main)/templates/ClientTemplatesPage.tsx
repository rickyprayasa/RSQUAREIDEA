...
export default function ClientTemplatesPage({ initialTemplates, initialCategories }: ClientTemplatesPageProps) {
    return (
                        ...
                        >
                            ...
                            <span className="relative inline-block">
                                <motion.span
                                    ...
                                    className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 via-amber-500 to-orange-600 bg-[length:200%_auto] animate-gradient"
                                >
                                    Segala Kebutuhan
                                </motion.span>
                                <motion.span
                                    ...
                                    className="absolute -bottom-1 left-0 right-0 h-2 bg-orange-200/60 -z-10 origin-left"
                                />
                            </span>
                        </motion.h1>
                        <motion.p
